...
namespace Proyecto_Asp_Final.Controllers
{
    public class CargosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_De_Cargo,Nombre,Descripcion")] Cargos cargos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_De_Cargo,Nombre,Descripcion")] Cargos cargos)
        {
            if (ModelState.IsValid)
            {
